module.exports = function (RED) {
    ...
    function MSCDSNode(config) {
        ...
        var sendData = function (data) {
            ...
            var msgObj = JSON.parse(data.toString());
            var jsonObject = {};
            ...
            var message = new Message(dataObject);
    ...
    RED.nodes.registerType("mscds", MSCDSNode, {
        credentials: {
            connectionstring: { type: "text" }
        },
        elements: {
            messagecatalogid: { type: "text" },
            type: { type: "text" }
        },
        defaults: {
